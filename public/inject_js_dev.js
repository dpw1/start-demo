...
//       _products.length
//     }">
//     <p class="EzfyCart-title">Complete your purchase</p>
...
//       console.log(",restartType,", restartType);
//       if ($ezfycart) {
...
//       console.log("mh options", options, errors);
...
//     console.log(window.ezfyCheckoutAppHasBeenLoaded);
