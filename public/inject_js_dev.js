...
//      const result = allProducts.filter(obj1 => products.some(obj2 => obj2.id === obj1.id));
...
//       if (_products.length <= 0 && $ezfycart) {
//         $ezfycart.remove();
...
//         if (each.galleryImages.length>=1 && window.ezfyUpsellData.settings.enableSecondImageOnHover){
//         	secondImage += `
//         		<img
//         		loading="lazy"
